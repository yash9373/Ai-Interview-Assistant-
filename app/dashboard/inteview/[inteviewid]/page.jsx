    ...
    return (
        <div className="flex flex-col items-center my-10 p-5 bg-gray-100 rounded-lg shadow-lg">
            ...
            <div className="w-full mb-6 p-4 bg-red-100 text-red-800 rounded-lg shadow-md">
                ...
                <p>Please enable your webcam to start the interview. You will be asked 11 questions, and based on your responses, a detailed report will be generated at the end.</p>
            </div>

            <h2 className="font-bold text-3xl text-gray-800 mb-6">Let's get started</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 w-full gap-6 items-start">
                ...
                <div className='flex flex-col h-full bg-white p-6 rounded-lg shadow-lg space-y-4'>
                    {interviewData ? (
                        <>
                            <h2 className='text-xl text-gray-800'><strong>Job Role / Job Position: </strong>{interviewData.jobPosition}</h2>
                            <h2 className='text-xl text-gray-800'><strong>Job Description / Tech Stack: </strong>{interviewData.jobDesc}</h2>
                            <h2 className='text-xl text-gray-800'><strong>Years of Experience: </strong>{interviewData.jobExp}</h2>
                            <h2 className='text-xl text-gray-800'><strong>Projects and Skills from Your Resume: </strong>{interviewData.Resume}</h2>
                        </>
                    ) : (
